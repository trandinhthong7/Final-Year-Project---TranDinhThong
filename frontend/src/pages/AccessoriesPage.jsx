...
const AccessoriesPage = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row">
            ...
            >
                <FilterSidebar category="ACCESSORIES" />
            </div>
            
            <div className="flex-grow p-4">
                <h2 className="text-2xl uppercase mb-4 text-[#001e1d] font-bold">All Accessories</h2>
                <p className="text-[#004643] mb-4">Balls, Socks, Tape & More</p>
                <SortOptions />
                {products.length === 0 ? (
